Rails.application.configure do
  ...
  config.action_mailer.asset_host = "https://" + Rails.application.secrets.host_name
  ...
  :email => {
    :email_prefix => "[Txst Signup] ",
    :sender_address => %{"Txst Signup Error" <nobody@#{Rails.application.secrets.domain_name}>},
